...
include 'Model/allsolutionsDAO.php';
include '../Model/allsolutionsDAO.php';
...
$allsolutions = '';
while($row_allsolutions_zh = mysql_fetch_array($retval_allsolutions_zh, MYSQL_ASSOC)){
    $idx = $row_allsolutions_zh['idx'];
    $text4 = $row_allsolutions_zh['text4'];
    $text6 = $row_allsolutions_zh['text6'];
    $image = $row_allsolutions_zh['image4']; 
    $url = $row_allsolutions_zh['url'];

                 $allsolutions .= '<a href="/Solutions/Solution/'.$url.'" class="all-item">
...
$row_singlesolutionzh = mysql_fetch_array($retval_singlesolutionzh, MYSQL_ASSOC);
    $solution_idx = $row_singlesolutionzh['idx']; 
