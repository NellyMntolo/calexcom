...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/themes/greentheme/views/site/Admin/Assets/css/modal.css">
...
<div id="wrapper">
	...
	<form name="login-form" class="login-form" action="" method="POST">	
		<div class="header">
		<h3><a href="/Home"><img  style="width: 238px; height: 40px;" src="/themes/greentheme/views/site/Assets/img/calex-2.png"></a></h3>
		...
		<div class="content">
			...
			<img src="/themes/greentheme/views/site/Admin/custom-captcha.php"/>
