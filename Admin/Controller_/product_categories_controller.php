...
if(isset($_POST['new_category_submit'])){
 ...
 $max = 'SELECT sortable_order FROM shop_hovvver_product_categories where code="'.$current_lang.'" ORDER BY sortable_order DESC';
  ...
  $tag_max = 'SELECT category_id FROM shop_hovvver_product_categories ORDER BY category_id DESC';
...
$enurl = str_replace($vowels, '_', $entext1);
  ...
  $sqla = 'INSERT INTO shop_hovvver_product_categories (code, category_name, category_id, sortable_order, image1, url) VALUES ("'.$current_lang.'", "'.$entext1.'","'.$tag_large.'"+1,"'.$large.'"+1, "'.$uploaded_image1.'", "'.$enurl.'")';            
...
if(isset($_POST['update_category_submit'])){
  ...
  $sql="UPDATE shop_hovvver_product_categories SET category_name='".$entext1."', url='".$enurl."' WHERE category_id='".$categoryid."' AND code='".$current_lang."' ";              
    ...
    if($image1 != null) {
      ...
      $sql1="UPDATE shop_hovvver_product_categories SET image1='".$filename."' WHERE category_id ='".$categoryid."' AND code='".$current_lang."'";
...
if(isset($_POST['delete_category'])){
  $categoryid = mysql_real_escape_string($_POST['category_id'],$conn);
        ...
        $sqlin = 'DELETE FROM shop_hovvver_product_categories WHERE category_id ="'.$categoryid.'" ';
        ...
        $sqlreseten1 = "ALTER TABLE shop_hovvver_product_categories DROP idx; ";
        $sqlreseten2 = "ALTER TABLE shop_hovvver_product_categories AUTO_INCREMENT = 1; ";
        $sqlreseten3 = "ALTER TABLE shop_hovvver_product_categories ADD idx int UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST; ";
        ...
        $sqlcategoryin = 'DELETE FROM shop_hovvver_product_category_list WHERE category_id ="'.$categoryid.'" ';
        ...
        $sqlresetcategory1 = "ALTER TABLE shop_hovvver_product_category_list DROP idx; ";
        $sqlresetcategory2 = "ALTER TABLE shop_hovvver_product_category_list AUTO_INCREMENT = 1; ";
        $sqlresetcategory3 = "ALTER TABLE shop_hovvver_product_category_list ADD idx int UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST; ";
