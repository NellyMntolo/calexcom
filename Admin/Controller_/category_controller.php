...
if(isset($_POST['add_category'])){
  ...
  $sqla = 'INSERT INTO hovvver_categories (code, text1, text2, sortable_order) VALUES ("'.$current_lang.'", "'.$entext1.'","'.$category_large.'"+1,"'.$large.'"+1)';            
                   ...
                   if(! $retvala )
                       ...
                       header("Refresh:0; url=/Admin/CaseStudyCategories");     
}
...
if(isset($_POST['edit_category'])){
  ...
  $cataglang = mysql_real_escape_string($_POST['catag_lang'],$conn);
    ...
    $sqla = 'INSERT INTO hovvver_categories (code, text1, text2, sortable_order) VALUES ("'.$cataglang.'", "'.$entext3.'","'.$categorygroup.'","'.$large.'"+1)';            
                   $retvala = mysql_query( $sqla, $conn );
                   if(! $retvala )
                       {
                          die('Could not enter data: ' . mysql_error());
  ...
  $sql="UPDATE hovvver_categories SET text1='".$entext1."' WHERE idx='".$categoryid."' AND code='".$current_lang."' ";              
...
if(isset($_POST['delete_category'])){
  ...
  $strap = 'SELECT sortable_order FROM hovvver_categories WHERE idx = '.$categoryid.' AND code="'.$current_lang.'" LIMIT 1';
  ...
  $returnstrap = $rowstrapen['sortable_order'];
        ...
        $sqlin = 'DELETE FROM hovvver_categories WHERE text2 ="'.$categorygroup.'" ';
        ...
        $retvalreseten3 = mysql_query( $sqlreseten3, $conn );
                  if(! $retvalreseten1 )
                       ...
                       $sqlen="UPDATE hovvver_categories SET sortable_order= sortable_order-1  WHERE sortable_order >'".$returnstrap."' ";              
