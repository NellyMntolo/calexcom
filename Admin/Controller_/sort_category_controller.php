...
$array = $_POST['projectLis'];
  ...
  foreach ($array as $key => $value) {
    # code...
    $query = "UPDATE hovvver_categories SET sortable_order = ".$x." WHERE idx = ". $value;
...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                        ...
                        $sqlprojecten = 'select * from hovvver_categories where code="'.$current_lang.'" ORDER BY sortable_order ASC';
