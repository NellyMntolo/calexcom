...
//if(isset($_POST['selected_tag'])){ 
  ...
  $sql_category = 'SELECT * FROM hovvver_project WHERE idx = "'.$selected_option.'" and code ="'.$current_lang.'" ';    
     ...
     if(! $retval_category )
     {
      ...
      $sql_all_categories = 'SELECT * FROM hovvver_category_list WHERE text1 = "'.$misc_id.'" and code ="'.$current_lang.'" ';    
