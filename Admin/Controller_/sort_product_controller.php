...
$array = $_POST['blogList'];
  ...
  foreach ($array as $key => $value) {
    # code...
    $query = "UPDATE hovvver_blog SET sortable_order = ".$x." WHERE idx = ". $value;
...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
                        ...
                        $sqlblogen = 'select * from hovvver_blog where code ="'.$current_lang.'" ORDER BY sortable_order ASC';
