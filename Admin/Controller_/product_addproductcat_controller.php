...
*/
     ...
     $sql_misc = 'SELECT * FROM shop_hovvver_product WHERE product_id = "'.$selected_option.'" ';    
     ...
     if(! $retval_misc )
     {
      ...
      if ($misc_id != null) {
          $sql_option_name1 = 'SELECT * FROM shop_hovvver_product_category_list WHERE product_id != "'.$misc_id.'" ';
           ...
           while($rowoption1 = mysql_fetch_array($retval_option_name, MYSQL_ASSOC)){
                ...
                if (!empty($all_catagsnames)) {
                  ...
                  //foreach ($all_catagsnames as $key => $value) {
                      //$sql_catagnames = 'SELECT * FROM shop_hovvver_product_categories WHERE category_id = "'.$value.'" and code ="'.$current_lang.'" ORDER BY category_id ASC ';
                      $sql_catagnames = 'SELECT * FROM shop_hovvver_product_categories WHERE code ="'.$current_lang.'" ORDER BY category_id ASC ';
                  ...
                  $sql_option_name2 = 'SELECT * FROM shop_hovvver_product_category_list ';
                  $retval_option_name2 = mysql_query( $sql_option_name2, $conn );     
                   if(! $retval_option_name2 )
                   {
                    ...
                    //foreach ($all_catagsnames2 as $keys => $values) {
                      ...
                      //$sql_option_name_check = 'SELECT * FROM shop_hovvver_product_categories where category_id != "'.$values.'" and code ="'.$current_lang.'" ORDER BY category_id ASC'; 
                     $sql_option_name_check = 'SELECT * FROM shop_hovvver_product_categories WHERE category_id NOT IN ('.implode($all_catagsnames2,',').')  and code ="'.$current_lang.'" ORDER BY category_id ASC';    
                    ...
                    //}
                             ...
                             $sql_option_name3 = 'SELECT * FROM shop_hovvver_product_categories where code ="'.$current_lang.'" ORDER BY category_id ASC';    
