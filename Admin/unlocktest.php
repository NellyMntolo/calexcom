...
<html>
  <head>
    ...
    <title>Hovvver | Lockscreen</title>
    ...
    <link rel="stylesheet" href="/themes/greentheme/views/site/Admin/Assets/css/skins/skin-blue.css">
  ...
  <body class="hold-transition lockscreen">
    ...
    <div class="lockscreen-wrapper">
      ...
      <div class="lockscreen-footer text-center">
        Copyright &copy; <?php echo date('Y'); ?>.</b><br>
        All rights reserved.
      </div>
    </div><!-- /.center -->
