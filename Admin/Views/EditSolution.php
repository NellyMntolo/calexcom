...
include '../Model/editsolutionDAO.php';
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                ...
                <li><a href="/Admin/ViewAllTechnologies/" style="color:white;"><i class="fa fa-tv"></i>View All Technologies<span class="label label-primary pull-right"><?php echo $allthinkers_idx; ?></span></a></li>
              </ul>
            </li>
            <li class="treeview">
      ...
      <div class="modal-frame1">
        <div class="modal1">
              ...
              Please select images to delete
                  ...
                  <form action="/Admin/AllTechnologies" method="POST">
                  ...
                  <div class="modal-body1">
                      <div class="">
                          ...
                          <div style="position: relative; float: left; width: 210px; margin-top: 10px;">
                              <input type="hidden" name="check_image4" value="no"> 
                              <input type="checkbox" name="check_image4" value="yes" class="mycheckbox">
                              <img src="<?php echo $enimage4; ?>" style="width: 200px; height: 150px;" name="image4" class="checkimage">
                          </div>
                      </div>
                      <p class="ps"></p>
                  </div>
                  <input type="hidden" value="<?php echo $idx; ?>" name="case_id">
...
<form id="allform" action="/Admin/AllTechnologies" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
<!-- MODAL -->
...
<!-- MODAL -->
        ...
        <input type="hidden" value="<?php echo $idx; ?>" name="solution_id">        
<!-- General Settings -->
            ...
            <div class="box-body pad">                  
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input id="entitle" type="text" name="content_entext1" class="form-control" placeholder="Technology Title" value="<?php echo $entext4; ?>">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group" style="width: 95%;">
                      <label>Logo</label>
                      <input type="file" name="solution_image2">
                      <img src="<?php echo $enimage2; ?>">
                    </div>

                    <div class="form-group" style="width: 95%;">
                      <label>Background image</label>
                      <input type="file" name="solution_image3">
