          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                ...
                <li><a href="/Admin/Technology/" style="color:white;"><i class="fa fa-edit"></i>Technology</a></li>
...
<form action="/Admin/AllTechnologies/" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
<!-- MODAL -->
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad"> 
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext1" placeholder="Slogan Description"><?php echo $entext5;?></textarea>
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext2" placeholder="Title"><?php echo $entext6;?></textarea>
                    </div><!-- /.input group -->                       
                    </div>
