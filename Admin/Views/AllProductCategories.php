...
include '../Model/product_categoriesDAO.php';
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                ...
                <li><a href="/Admin/ProductCategories" style="color:white;"><i class="fa fa-clone"></i><span>Product Categories</span></a></li>
              </ul>
            </li>
            <li class="treeview">
            ...
            <div class="col-md-12">
                <div class="box box-solid">
                      <div class="box-header width-border">                        
                          ...
                          <button class="pull-right btn btn-success" title="New Category"  style="margin-right: 10px;" onclick="window.location='/Admin/NewProductCategory/';"><i class="fa fa-plus"></i></button>
                      </div><!-- /.box-header -->
                    <div class="box-body">
