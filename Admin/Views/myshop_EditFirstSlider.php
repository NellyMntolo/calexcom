...
include '../Model/myshop_editfirstsliderDAO.php';
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="/Admin/Home/" class="logo">
          ...
          <span class="logo-mini"><b>2</b>h-F</span>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="location_entext1" class="form-control" placeholder="Slider URL" value="<?php echo $entext1; ?>">
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <!-- <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="location_entext2" placeholder="Slider Description"><?php echo $entext2; ?></textarea>
                    </div>                  
                    </div> -->
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="location_entext3" class="form-control" placeholder="Slider Button" value="<?php echo $entext3; ?>">
                    </div><!-- /.input group -->                       
                    </div>
