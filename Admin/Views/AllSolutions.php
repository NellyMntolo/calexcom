        ...
        <!-- General Settings -->
          <div class="box box-solid">
            <div class="box-header">
              <h3 class="box-title">Current Technologies</h3>
            ...
            <div id="sorter" class="box-body pad">
                    <?php while($rowprojecten = mysql_fetch_array($retvalprojecten, MYSQL_ASSOC)){
                      ...
                      $sortable_order = $rowprojecten['sortable_order'];
                              ...
                              echo "<form action=\"/Admin/EditTechnology\" method=\"GET\" enctype=\"multipart/form-data\" accept-charset=\"utf-8\">";
                              echo '<img src="'.$rowprojecten['image1'].'"/>';
                              echo "<input type=\"hidden\" value=\"$idx\" name=\"solution_id\">";
