          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                <li><a href="/Admin/AddProduct" style="color:white;"><i class="fa fa-keyboard-o"></i>Create New Product</a></li>
            ...
            <div class="box-body pad">                  
                   ...
                   <div class="form-group" style="width: 95%;">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"  name="content_entext1" class="form-control" value="" placeholder="Product Title">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext4" class="form-control" placeholder="Button Text">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext5" class="form-control" placeholder="Button URL">
                    </div><!-- /.input group -->                      
                    </div>
