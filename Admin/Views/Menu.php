      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="/Admin/Menu/"><i class="fa fa-reorder"></i><span>Menu</span></a></li>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">                  
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext1" class="form-control" value="<?php echo $entext1 ?>" placeholder="Menu Item 1">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext2" class="form-control" value="<?php echo $entext2 ?>" placeholder="Menu Item 2">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext3" class="form-control" value="<?php echo $entext3 ?>" placeholder="Menu Item 3">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext4" class="form-control" value="<?php echo $entext4 ?>" placeholder="Menu Item 4">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext5" class="form-control" value="<?php echo $entext5 ?>" placeholder="Menu Item 5">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext6" class="form-control" value="<?php echo $entext6 ?>" placeholder="Menu Item 6">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext7" class="form-control" value="<?php echo $entext7 ?>" placeholder="Menu Item 7">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext8" class="form-control" value="<?php echo $entext8 ?>" placeholder="Menu Item 8">
                    </div><!-- /.input group -->                      
                    </div>
