...
include '../Model/editcasestudy_categoryDAO.php';
?>
...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/themes/greentheme/views/site/Admin/plugins/select2/select2.min.css">
    <!-- Theme style -->
    ...
    <script src="/themes/greentheme/views/site/Admin/ckeditor/ckeditor.js"></script>
...
<input type="hidden" name="category_id" value="<?php echo $category_id;?>">
    ...
    <script src="/themes/greentheme/views/site/Admin/plugins/select2/select2.full.min.js"></script>
