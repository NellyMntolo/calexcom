        ...
        <!-- General Settings -->
          <div class="box box-solid">
            <div class="box-header">
              <h3 class="box-title">Current Products</h3>
            ...
            <div id="sorter" class="box-body pad">
                    <?php while($rowprojecten = mysql_fetch_array($retvalprojecten, MYSQL_ASSOC)){
                      ...
                      $sortable_order = $rowprojecten['sortable_order'];
                              ...
                              echo "<form action=\"/Admin/EditProduct\" method=\"GET\" enctype=\"multipart/form-data\" accept-charset=\"utf-8\">";
