          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                ...
                <li><a href="/Admin/About/" style="color:white;"><i class="fa fa-edit"></i>About</a></li>
...
<!-- MODAL -->
        ...
        <!-- General Settings -->
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">
              ...
              <?php /*
                  <div class="form-group">
                      ...
                      <input type="text" name="content_entext1" class="form-control" value="<?php echo $entext4; ?>" placeholder="https://www.youtube.com/embed/wAEzpwvrveg">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    */ ?>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext1" class="form-control" value="<?php echo $entext4;?>" placeholder="Page Main Slogan">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext2" placeholder="Slogan Description"><?php echo $entext5;?></textarea>
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext3" placeholder="Title"><?php echo $entext6;?></textarea>
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext4" placeholder="Image Description"><?php echo $entext7; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div>                   
                    ...
                    <div class="form-group" style="width: 95%; margin-left: 2%;">
                      ...
                      <textarea class="form-control" id="news_text" rows="3" name="content_entext5" placeholder="All Content"></textarea>
                    </div><!-- /.input group -->                       
                    </div>
            ...
            <?php echo "<script>CKEDITOR.instances.news_text.setData('".mysql_real_escape_string($entext8, $conn)."')</script>"; ?>
