...
include '../Model/editcasestudyDAO.php';
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treevie menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                ...
                <li><a href="/Admin/ViewAllCaseStudies/" style="color:white;"><i class="fa fa-tv"></i>View All Case Studies<span class="label label-primary pull-right"><?php echo $allprojects_idx; ?></span></a></li>
              </ul>
            </li>
      ...
      <div class="modal-frame1">
        <div class="modal1">
              ...
              Please select images to delete
                  ...
                  <form action="/Admin/AllCase_Studies" method="POST">
            ...
            <div class="box-body pad">                  
                   ...
                   <div class="form-group" style="width: 95%;">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"  name="content_entext1" class="form-control" value="<?php echo $entext4; ?>" placeholder="Case Study Title">
                    </div><!-- /.input group -->                      
                    </div>
