          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                <li><a href="/Admin/AddTechnology" style="color:white;"><i class="fa fa-keyboard-o"></i>Create New technology</a></li>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">                  
                    ...
                    <!-- <div class="form-group">
                      ...
                      <input type="file" name="solution_image4">
                    </div> -->
                    ...
                    <div class="form-group">
                      ...
                      <input id="entitle" type="text" name="content_entext1" class="form-control" placeholder="Technology Title">
                    </div><!-- /.input group -->                         
                    </div>
