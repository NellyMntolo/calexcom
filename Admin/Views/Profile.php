...
<html>
  <head>
    ...
    background-image: url(/themes/greentheme/views/site/Admin/Assets/img/wink.svg);
            ...
            <div class="col-md-9">
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  ...
                  <li><a href="#google" data-toggle="tab">Additional SEO</a></li>
                </ul>
                <div class="tab-content" style="min-height: 300px;">
                  ...
                  <div class="form-group pass">
                    <label><small>SMTP</small> Password</label>
                    <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-circle-o"></i>
                      </div>
                      <input name="text6" class="form-control" type="password" placeholder="SMTP Password" value="">
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <select class="selectpicker" name="new_language">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <select class="selectpicker" name="default_language">
                        <option value="">Select</option>
                ...
                <div class="box-body">
                  ...
                  <div class="form-group" style="width: 90%; margin-left: 2%;">
                      <label>Google Analytics</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-keyboard-o"></i>
                      </div>
                      <textarea class="form-control" rows="10" name="google_analytics" placeholder="<script>
...
ga('send', 'pageview');
</script>"><?php echo $google_analytics; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
...
<!--
                    <div class="form-group" style="width: 90%; margin-left: 2%;">
                      ...
                      <textarea class="form-control" rows="10" name="google_tags" placeholder="<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-XXXX');</script>"><?php //echo $google_tags; ?></textarea>
                    </div>                    
                    </div>
                  -->
...
<div id="LoadingImage" style="display: none">
    ...
    <script src="/themes/greentheme/views/site/Admin/Assets/js/moment.js"></script>
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.37/js/bootstrap-datetimepicker.min.js"></script>

<script src="/themes/greentheme/views/site/Admin/Assets/js/hideShowPassword.min.js"></script>
...
<script src="/themes/greentheme/views/site/Admin/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="/themes/greentheme/views/site/Admin/plugins/datatables/dataTables.bootstrap.min.js"></script>
<script src="/themes/greentheme/views/site/Admin/Assets/js/tooltip.js"></script>
