...
include '../Model/myshop_reg_loginDAO.php';
              ...
              <ul class="treeview-menu menu-open">
                ...
                <a href=""><i class="fa fa-edit"></i>My Shop
                    <span class="pull-right-container">
                      ...
                      <li><a href="/Admin/myShop/RegLogin" style="color:white;"><i class="fa fa-circle-o"></i>Register/Login</a></li>
                    </ul>
                </li>
              </ul>
            </li>
...
<form action="/Admin/AllRegLoginMyShop" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
<!-- MODAL -->
      ...
      <div class="modal-overlay"></div>
          ...
          <div class="box box-solid">
            <div class="box-header">
              <h3 class="box-title">Register Settings</h3>
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group" style="width: 95%;">
                      ...
                      <input type="file" name="reg_login_image1">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext1" class="form-control" value="<?php echo $entext1;?>" placeholder="Title">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext2" class="form-control" value="<?php echo $entext2;?>" placeholder="Email">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext3" class="form-control" value="<?php echo $entext3;?>" placeholder="Password">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext4" class="form-control" value="<?php echo $entext4;?>" placeholder="Repeat Password">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext5" class="form-control" value="<?php echo $entext5;?>" placeholder="Your Name">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext6" class="form-control" value="<?php echo $entext6;?>" placeholder="Tel">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext7" class="form-control" value="<?php echo $entext7;?>" placeholder="Company Name">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext8" class="form-control" value="<?php echo $entext8;?>" placeholder="統一編號">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext9" class="form-control" value="<?php echo $entext9;?>" placeholder="Submit">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext10" class="form-control" value="<?php echo $entext10;?>" placeholder="Error Email">
                    </div><!-- /.input group -->                         
                    </div>


                    <div class="form-group">
                      <label>Error Required</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-pencil-square-o"></i>
                      </div>
                      <input type="text" name="content_entext11" class="form-control" value="<?php echo $entext11;?>" placeholder="Error Required">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext12" class="form-control" value="<?php echo $entext12;?>" placeholder="Error Password">
                    </div><!-- /.input group -->                         
                    </div>

                    <div class="form-group">
                      <label>Error Required Name</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-pencil-square-o"></i>
                      </div>
                      <input type="text" name="content_entext13" class="form-control" value="<?php echo $entext13;?>" placeholder="Error Required Name">
                    </div><!-- /.input group -->                         
                    </div>

                    <div class="form-group">
                      <label>Error Required Tel</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-pencil-square-o"></i>
                      </div>
                      <input type="text" name="content_entext14" class="form-control" value="<?php echo $entext14;?>" placeholder="Error Required Tel">
                    </div><!-- /.input group -->                         
                    </div>

                    <div class="form-group">
                      <label>Error Required Company Name</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-pencil-square-o"></i>
                      </div>
                      <input type="text" name="content_entext15" class="form-control" value="<?php echo $entext15;?>" placeholder="Error Required Company Name">
                    </div><!-- /.input group -->                         
                    </div>

                    <div class="form-group">
                      <label>Error Required 統一編號</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-keyboard-o"></i>
                      </div>
                      <input type="text" name="content_entext16" class="form-control" value="<?php echo $entext16;?>" placeholder="Error Required 統一編號">
                    </div><!-- /.input group -->                      
                    </div>      
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group" style="width: 95%;">
                      ...
                      <input type="file" name="reg_login_image2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext17" class="form-control" value="<?php echo $entext17;?>" placeholder="Title">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext18" class="form-control" value="<?php echo $entext18;?>" placeholder="Email">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext19" class="form-control" value="<?php echo $entext19;?>" placeholder="Password">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext20" class="form-control" value="<?php echo $entext20;?>" placeholder="Forgot PW">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext21" class="form-control" value="<?php echo $entext21;?>" placeholder="Remember">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext22" class="form-control" value="<?php echo $entext22;?>" placeholder="Submit">
                    </div><!-- /.input group -->                         
                    </div>
          ...
          <div class="box box-solid">
            <div class="box-header">
              <h3 class="box-title">Forgot Password Settings</h3>
                  <div class="pull-right box-tools">
                    <button class="btn btn-default btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                    <!--<button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>-->
                  </div><!-- /. tools -->
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group" style="width: 95%;">
                      ...
                      <input type="file" name="reg_login_image3">
                    ...
                    <div class="form-group">
                      ...
                      <textarea rows="3" name="content_entext23" class="form-control" placeholder="Title"><?php echo $entext23;?></textarea>
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext24" class="form-control" value="<?php echo $entext24;?>" placeholder="Email">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext25" class="form-control" value="<?php echo $entext25;?>" placeholder="Submit">
                    </div><!-- /.input group -->                         
                    </div>
          ...
          <div class="box box-solid">
            <div class="box-header">
              <h3 class="box-title">Reset Password Settings</h3>
                  <div class="pull-right box-tools">
                    <button class="btn btn-default btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                    <!--<button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>-->
                  </div><!-- /. tools -->
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group" style="width: 95%;">
                      <label>Background</label>
                      <input type="file" name="reg_login_image4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext26" class="form-control" value="<?php echo $entext26;?>" placeholder="Title">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext27" class="form-control" value="<?php echo $entext27;?>" placeholder="Original Password">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext28" class="form-control" value="<?php echo $entext28;?>" placeholder="New Password">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext29" class="form-control" value="<?php echo $entext29;?>" placeholder="Repeat New Password">
                    </div><!-- /.input group -->                         
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext30" class="form-control" value="<?php echo $entext30;?>" placeholder="Submit">
                    </div><!-- /.input group -->                         
                    </div>
