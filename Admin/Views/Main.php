          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                <li><a href="/Admin/Main/" style="color:white;"><i class="fa fa-edit"></i>Index</a></li>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext1" class="form-control"  value="<?php echo $entext4; ?>" placeholder="Title 1">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext2" class="form-control"  value="<?php echo $entext5; ?>" placeholder="Title 2">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext3" class="form-control"  value="<?php echo $entext6; ?>" placeholder="Title 3">
                    </div><!-- /.input group -->                      
                    </div>
