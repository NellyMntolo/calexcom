...
include '../Model/maincasestudyDAO.php';
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                ...
                <li><a href="/Admin/Case_Studies/" style="color:white;"><i class="fa fa-edit"></i>Case Studies</a></li>
...
<form action="/Admin/AllCase_Studies" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
<!-- MODAL -->
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">    
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext1" placeholder="Description"><?php echo $entext5;?></textarea>
                    </div><!-- /.input group -->                      
                    </div> 
