      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="/Admin/Footer/"><i class="fa fa-wheelchair"></i><span>Footer</span></a></li>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text4" class="form-control" value="<?php echo $entext4; ?>" placeholder="Title">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text1" class="form-control" value="<?php echo $entext1; ?>" placeholder="Page Footer Tel ">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text2" class="form-control" value="<?php echo $entext2; ?>" placeholder="Page Footer Email ">
                    </div><!-- /.input group -->                      
                    </div>

                    <div class="form-group">
                      <label>Page Footer Description</label>
                      <div class="input-group">
                      <div class="input-group-addon">
                        <i class="fa fa-keyboard-o"></i>
                      </div>
                      <textarea class="form-control" rows="3" name="content_text3" placeholder="Page Footer Description"><?php echo $entext3; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div> 
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text5" class="form-control" value="<?php echo $entext5; ?>" placeholder="Text 1">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_text11" class="form-control" value="<?php echo $entext11; ?>" placeholder="Text 7">
                    </div><!-- /.input group -->                      
                    </div>
            ...
            <div class="box-header" style="padding-left: 50px;">
              <h3 class="box-title"> Add new</h3>
                    ...
                    <div class="col-lg-4 form-group" style="width: 29%; float: left; margin-left:2%;">
                      ...
                      <label>Icon <small>(eg: fa fa-icon_name) </small><a href="https://fontawesome.com/icons?d=gallery" target="_blank">Icon Reference</a></label>
                      <div class="input-group">
                        <div class="input-group-addon" style="height: 40px;">
                          <i class="fa fa-pencil-square-o"></i>
                        </div>
                        <input style="height: 40px;" type="text" name="social_image" class="form-control"  placeholder="fa fa-icon_name">
                      </div><!-- /.input group -->
                    ...
                    <div class="row" >
                            <div class="form-group" style="width: 29%; float: left; margin-left:2%;">
                              <label>Icon <small>(eg: '.$image.') </small><a href="https://fontawesome.com/icons?d=gallery" target="_blank">Icon Reference</a></label>
                              <div class="input-group">
                              <i style="font-size:40px;" class="'.$image.'"></i>
                              <!-- <div class="input-group-addon" style="height: 40px;">
                                <i class="fa fa-pencil-square-o"></i>
                              </div> -->
                              <input style="height: 40px;" type="text" name="social_image" class="form-control"  value="'.$image.'">
                            </div><!-- /.input group -->
                            </div>              
