...
include '../Model/myshop_mainDAO.php';
              ...
              <ul class="treeview-menu menu-open">
                ...
                <a href=""><i class="fa fa-edit"></i>My Shop
                    <span class="pull-right-container">
                      ...
                      <li><a href="/Admin/myShop/Main" style="color:white;"><i class="fa fa-circle-o"></i>Index</a></li>
...
<form action="/Admin/AllMainMyShop" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
<!-- MODAL -->
          ...
          <div class="box box-solid">
            ...
            <div class="box-body pad">
                    ...
                    <div class="form-group" style="width: 95%;">
                      <label>Banner</label>
                      <input type="file" name="index_image1">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext1" class="form-control"  value="<?php echo $entext4; ?>" placeholder="Slogan">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext2" class="form-control"  value="<?php echo $entext5; ?>" placeholder="Email">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext3" class="form-control"  value="<?php echo $entext6; ?>" placeholder="Password">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext4" class="form-control"  value="<?php echo $entext7; ?>" placeholder="Submit">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext5" class="form-control"  value="<?php echo $entext8; ?>" placeholder="Title">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext6" placeholder="Description"><?php echo $entext9; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext7" class="form-control"  value="<?php echo $entext10; ?>" placeholder="Title">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext8" placeholder="Description"><?php echo $entext11; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext9" class="form-control"  value="<?php echo $entext12; ?>" placeholder="Title">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext10" class="form-control"  value="<?php echo $entext13; ?>" placeholder="Title">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext11" placeholder="Description"><?php echo $entext14; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext12" class="form-control"  value="<?php echo $entext15; ?>" placeholder="Title">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext13" placeholder="Description"><?php echo $entext16; ?></textarea>
                    </div><!-- /.input group -->                      
                    </div>
                  ...
                  <div class="box box-solid">
                    ...
                    <div class="box-body pad">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="location_entext1" class="form-control" placeholder="Slider URL">
                            </div><!-- /.input group -->                       
                            </div>
                            ...
                            <!-- <div class="form-group">
                              ...
                              <textarea class="form-control" rows="3" name="location_entext2" placeholder="Slider Description"></textarea>
                            </div>                  
                            </div> -->
<?php /*
                            <div class="form-group">
                              ...
                              <input type="text" name="location_entext3" class="form-control" placeholder="Slider Button">
                            </div><!-- /.input group -->                       
                            </div>
...
*/ ?>
                  ...
                  <!-- General Settings -->
                    ...
                    <div class="box box-solid">
                      <div class="box-header">
                        <h3 class="box-title">Current Slides</h3>
                            <div class="pull-right box-tools">
                              <button class="btn btn-default btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                              <!--<button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>-->
                            </div><!-- /. tools -->
                      ...
                      <div class="box-body pad">
                              <?php while($rowfirst = mysql_fetch_array($retvalfirst, MYSQL_ASSOC)){
                                      $firstidx = $rowfirst['idx']; 
                                      $firstentext1 = $rowfirst['text1'];
                                      //$firstentext2 = $rowfirst['text2'];
                                      $firstimage1 = $rowfirst['image1'];
                                        
                                        echo "<div class=\"project-list\">";
                                        echo "<form action=\"/Admin/FirstSliderEditMyShop\" method=\"GET\" enctype=\"multipart/form-data\" accept-charset=\"utf-8\">";
                                        echo '<img src="'.$firstimage1.'"/>';
                                        echo "<input type=\"hidden\" value=\"$firstidx\" name=\"first_slider_id\">";
                                        echo "<input type=\"text\" value=\"$firstentext1\" name=\"\" readonly style=\"width: 100%;\">";
