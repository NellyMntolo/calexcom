...
include '../Model/casestudyDAO.php';
        ...
        <!-- General Settings -->
          <div class="box box-solid">
            <div class="box-header">
              <h3 class="box-title">Current Case Studies</h3>
            ...
            <div id="sorter" class="box-body pad">
                    <?php while($rowprojecten = mysql_fetch_array($retvalprojecten, MYSQL_ASSOC)){
                      ...
                      $titles = $rowprojecten['text4'];
                      $idx = $rowprojecten['idx'];
                      $sortable_order = $rowprojecten['sortable_order'];
                              
                              echo "<div id=\"projectList_$idx\" class=\"project-list\">";
                              echo "<form action=\"/Admin/EditCaseStudy\" method=\"GET\" enctype=\"multipart/form-data\" accept-charset=\"utf-8\">";
                              echo '<img src="'.$rowprojecten['image1'].'"/>';
                              echo "<input type=\"hidden\" value=\"$idx\" name=\"case_id\">";
                              echo "<input type=\"text\" value=\"$titles\" name=\"\" readonly style=\"width: 100%;\">";
