          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview menu-open active">
              ...
              <ul class="treeview-menu menu-open">
                <li><a href="/Admin/AddCaseStudy" style="color:white;"><i class="fa fa-keyboard-o"></i>Create New Case Study</a></li>
...
<form id="allform" action="/Admin/AllCase_Studies" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
            ...
            <div class="box-body pad">                  
                   ...
                   <div class="form-group" style="width: 95%;">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text"  name="content_entext1" class="form-control" placeholder="Case Study Title">
                    </div><!-- /.input group -->                      
                    </div>
                   ...
                   <hr class="hrs">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext2" class="form-control" placeholder="Short Slogan">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext3" placeholder="Description"></textarea>
                    </div><!-- /.input group -->                      
                    </div>
...
<?php /*
                     <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext4" placeholder="Short Description"></textarea>
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext5" class="form-control" value="" placeholder="URL">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext6" class="form-control" value="" placeholder="Bullet Point">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext7" class="form-control" value="" placeholder="Bullet Point">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext8" class="form-control" value="" placeholder="Bullet Point">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext9" class="form-control" value="" placeholder="Bullet Point">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input  type="text" name="content_entext10" class="form-control" value="" placeholder="Content Title">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext11" placeholder="Content Description"></textarea>
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="content_entext12" class="form-control" value="" placeholder="Content Title">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="content_entext13" placeholder="Content Description"></textarea>
                    </div><!-- /.input group -->                       
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input  type="text" name="content_entext14" class="form-control" value=""  placeholder="URL">
                    </div><!-- /.input group -->                      
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input  type="text" name="content_entext15" class="form-control" value=""  placeholder="Button Text">
                    </div><!-- /.input group -->                      
                    </div>
*/ ?>
