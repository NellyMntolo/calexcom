...
if(isset($_POST['new_category_submit'])){
  ...
  $max = 'SELECT sortable_order FROM hovvver_categories where code="'.$current_lang.'" ORDER BY sortable_order DESC';
  ...
  $category_max = 'SELECT text2 FROM hovvver_categories ORDER BY text2 DESC';
  ...
  $sqla = 'INSERT INTO hovvver_categories (code, text1, text2, sortable_order, image1) VALUES ("'.$current_lang.'", "'.$entext1.'","'.$category_large.'"+1,"'.$large.'"+1, "'.$uploaded_image1.'")';            
...
if(isset($_POST['update_category_submit'])){
  ...
  $sql="UPDATE hovvver_categories SET text1='".$entext1."' WHERE text2='".$categoryid."' AND code='".$current_lang."' ";              
    ...
    if($image1 != null) {
      ...
      $sql1="UPDATE hovvver_categories SET image1='".$filename."' WHERE text2 ='".$categoryid."' AND code='".$current_lang."'";
...
if(isset($_POST['delete_category'])){
  $categoryid = mysql_real_escape_string($_POST['category_id'],$conn);
        ...
        $sqlin = 'DELETE FROM hovvver_categories WHERE text2 ="'.$categoryid.'" ';
        ...
        $sqlreseten1 = "ALTER TABLE hovvver_categories DROP idx; ";
        $sqlreseten2 = "ALTER TABLE hovvver_categories AUTO_INCREMENT = 1; ";
        $sqlreseten3 = "ALTER TABLE hovvver_categories ADD idx int UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST; ";
        ...
        $sqlcategoryin = 'DELETE FROM hovvver_category_list WHERE text2 ="'.$categoryid.'" ';
        ...
        $sqlresetcategory1 = "ALTER TABLE hovvver_category_list DROP idx; ";
        $sqlresetcategory2 = "ALTER TABLE hovvver_category_list AUTO_INCREMENT = 1; ";
        $sqlresetcategory3 = "ALTER TABLE hovvver_category_list ADD idx int UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST; ";
