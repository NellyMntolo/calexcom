...
//if(isset($_POST['selected_tag'])){ 
  ...
  $sql_category = 'SELECT * FROM shop_hovvver_product WHERE product_id = "'.$selected_option.'" ';    
     ...
     if(! $retval_category )
     {
      ...
      $sql_all_categories = 'SELECT * FROM shop_hovvver_product_category_list WHERE product_id = "'.$misc_id.'" ';    
      ...
      $sql_all_categories_names = 'SELECT * FROM shop_hovvver_product_categories WHERE category_id = "'.$all_categories.'" and code ="'.$current_lang.'" ';    
