...
if(isset($_POST['page_submit'])){
 ...
 $sql="UPDATE hovvver_footer SET text1='".$entext1."', text2='".$entext2."', text3='".$entext3."', text4='".$entext4."', text5='".$entext5."', text6='".$entext6."', text7='".$entext7."', text8='".$entext8."', text9='".$entext9."', text10='".$entext10."', text11='".$entext11."' where code ='".$current_lang."' ";              
...
$uploaded_image = '';
  ...
  $socialtext3 = mysql_real_escape_string($_POST['social_image'],$conn);
...
if($socialtext1 != null){
  $sqlb = 'INSERT INTO hovvver_social (text1, text2, image1) VALUES ( "'.$socialtext1.'", "'.$socialtext2.'", "'.$socialtext3.'")';
...
if(isset($_POST['edit_social'])){
  ...
  //$image1 = $_FILES['social_image']['name'];
   ...
   $sql="UPDATE hovvver_social SET text1='".$socialtext1."', text2='".$socialtext2."', image1='".$socialtext3."' WHERE idx='".$socialid."' LIMIT 1";              
                   $retval = mysql_query( $sql, $conn );
                   if(! $retval )
                       {
                          die('Could not enter data: ' . mysql_error());
...
//       $sql1="UPDATE hovvver_social SET image1='".$filename."' WHERE idx ='".$socialid."'";
...
if(isset($_POST['delete_social'])){
  $social_id = mysql_real_escape_string($_POST['social_id'],$conn);
        ...
        $sqlin = 'DELETE FROM hovvver_social WHERE idx ="'.$social_id.'" LIMIT 1';
        ...
        $sqlreseten1 = "ALTER TABLE hovvver_social DROP idx; ";
        $sqlreseten2 = "ALTER TABLE hovvver_social AUTO_INCREMENT = 1; ";
        $sqlreseten3 = "ALTER TABLE hovvver_social ADD idx int UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST; ";
