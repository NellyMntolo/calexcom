...
if(isset($_POST['page_submit'])){
 ...
 $sql="UPDATE hovvver_contact SET text1='".$entext1."', text2='".$entext2."', text3='".$entext3."', text4='".$entext4."', text5='".$entext5."', text6='".$entext6."', text7='".$entext7."', text8='".$entext8."', text9='".$entext9."', text10='".$entext10."' WHERE code='".$current_lang."' ";              
    ...
    if($image1 != null) {
      ...
      $sql1="UPDATE hovvver_contact SET image1='".$filename."' ";//where code ='".$current_lang."'
