...
if(isset($_POST['category_test'])){
    ...
    $sqlb = 'SELECT * FROM hovvver_blog WHERE idx = "'.$project_id.'" ';
...
if(isset($_POST['create_project_submit'])){
  ...
  $max = 'SELECT sortable_order FROM hovvver_blog WHERE code="'.$current_lang.'" ORDER BY sortable_order DESC';
  ...
  $max_misc = 'SELECT misc_id FROM hovvver_blog WHERE code="'.$current_lang.'" ORDER BY misc_id DESC';
...
$enurl = str_replace($vowels, '_', $entext4);
  $sqla = 'INSERT INTO hovvver_blog (code, text1, text2, text3, text4, text5, text6, text7, text8, image1, image2, image3, sortable_order, url, misc_id) VALUES ( "'.$current_lang.'", "'.$entext1.'", "'.$entext2.'", "'.$entext3.'", "'.$entext4.'", "'.$entext5.'", "'.$entext6.'", "'.$entext7.'", "'.$entext8.'", "'.$uploaded_image1.'", "'.$uploaded_image2.'", "'.$uploaded_image3.'", "'.$large.'"+1, "'.$enurl.'", "'.$themisc.'")';
  ...
  $retvala = mysql_query( $sqla, $conn );
    if(! $retvala ) {  
      ...
      header("Refresh:0; url=/Admin/ViewAllProducts");
...
$enurl = str_replace($vowels, '_', $entext4);
 ...
 $sql="UPDATE hovvver_blog SET text1='".$entext1."', text2='".$entext2."', text3='".$entext3."', text4='".$entext4."', text5='".$entext5."', text6='".$entext6."', text7='".$entext7."', text8='".$entext8."', url='".$enurl."'  WHERE idx='".$blogid."' AND code='".$current_lang."' AND misc_id='".$a."' LIMIT 1 ";              
    ...
    if($image1 != null) {
      ...
      $sql1="UPDATE hovvver_blog SET image1='".$filename."' WHERE idx ='".$blogid."'";// WHERE idx ='".$blogid."'
    ...
    if($image2 != null) {
      ...
      $sql2="UPDATE hovvver_blog SET image2='".$filename."' WHERE idx ='".$blogid."' ";//
    ...
    if($image3 != null) {
      ...
      $sql3="UPDATE hovvver_blog SET image3='".$filename."' WHERE idx ='".$blogid."' ";//
...
if(isset($_POST['delete_project_submit'])){
  ...
  $strap = 'SELECT sortable_order FROM hovvver_blog WHERE idx = "'.$blogid.'" AND code="'.$current_lang.'" LIMIT 1';
  ...
  $strap_misc = 'SELECT misc_id FROM hovvver_blog WHERE idx = "'.$blogid.'" AND code="'.$current_lang.'" LIMIT 1';
  ...
  $returnstrap_misc = $rowstrapen_misc['misc_id'];
        ...
        $sqlin = 'DELETE FROM hovvver_blog WHERE idx ="'.$blogid.'" AND code="'.$current_lang.'" LIMIT 1';
                 $retvalin = mysql_query( $sqlin, $conn );
                   if(! $retvalin )
                       {
                          die('Could not enter data: ' . mysql_error());
        ...
        $sqlreseten1 = "ALTER TABLE hovvver_blog DROP idx; ";
        $sqlreseten2 = "ALTER TABLE hovvver_blog AUTO_INCREMENT = 1; ";
        $sqlreseten3 = "ALTER TABLE hovvver_blog ADD idx int UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST; ";
        ...
        $retvalreseten3 = mysql_query( $sqlreseten3, $conn );
                  if(! $retvalreseten1 )
                    ...
                    $sqlen="UPDATE hovvver_blog SET sortable_order= sortable_order-1  WHERE sortable_order >'".$returnstrap."' AND code='".$current_lang."' ";              
                       $retvalen = mysql_query( $sqlen, $conn );
                       if(! $retvalen )
                           {
                              die('Could not enter data: ' . mysql_error());
                           }
                    $sqlen_misc="UPDATE hovvver_blog SET misc_id= misc_id-1  WHERE misc_id >'".$returnstrap_misc."' AND code='".$current_lang."' ";              
...
if($check_image1 == 'yes'){
 ...
 $sql="UPDATE hovvver_blog SET image1 = NULL  ";  //WHERE idx = '".$idx."'            
                   $retval = mysql_query( $sql, $conn );
                   if(! $retval )
                       {
                          die('Could not enter data: ' . mysql_error());
...
if(isset($_POST['page_submit'])){
 ...
 $sql="UPDATE hovvver_all_product SET text1='".$entext1."', text2='".$entext2."', text3='".$entext3."', text4='".$entext4."', text5='".$entext5."', text6='".$entext6."' where code ='".$current_lang."' ";
                   $retval = mysql_query( $sql, $conn );
                   if(! $retval )
                       {
                          die('Could not enter data: ' . mysql_error());
...
if($image1 != null) {
      ...
      move_uploaded_file($file_tmp1, getcwd()."/../../../../../../uploads/".$image1);
      $filename = "/uploads/".$image1;
      $sql1="UPDATE hovvver_all_product SET image1='".$filename."'";
      $retval1 = mysql_query( $sql1, $conn );
                   if(! $retval1 )
                       {
                          die('Could not enter image: ' . mysql_error());
