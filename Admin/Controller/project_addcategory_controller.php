...
*/
     ...
     $sql_misc = 'SELECT * FROM hovvver_project WHERE idx = "'.$selected_option.'" ';    
     ...
     if(! $retval_misc )
     {
      ...
      if ($misc_id != null) {
          $sql_option_name1 = 'SELECT * FROM hovvver_category_list WHERE text1 != "'.$misc_id.'" and code ="'.$current_lang.'" ';
           ...
           while($rowoption1 = mysql_fetch_array($retval_option_name, MYSQL_ASSOC)){
                ...
                if (!empty($all_catagsnames)) {
                  ...
                  //foreach ($all_catagsnames as $key => $value) {
                      //$sql_catagnames = 'SELECT * FROM hovvver_categories WHERE text2 = "'.$value.'" and code ="'.$current_lang.'" ORDER BY text2 ASC ';
                      $sql_catagnames = 'SELECT * FROM hovvver_categories WHERE code ="'.$current_lang.'" ORDER BY text2 ASC ';
                  ...
                  $sql_option_name2 = 'SELECT * FROM hovvver_category_list WHERE code ="'.$current_lang.'" ';
                  $retval_option_name2 = mysql_query( $sql_option_name2, $conn );     
                   if(! $retval_option_name2 )
                   {
                    ...
                    //foreach ($all_catagsnames2 as $keys => $values) {
                      ...
                      //$sql_option_name_check = 'SELECT * FROM hovvver_categories where text2 != "'.$values.'" and code ="'.$current_lang.'" ORDER BY text2 ASC'; 
                     $sql_option_name_check = 'SELECT * FROM hovvver_categories WHERE text2 NOT IN ('.implode($all_catagsnames2,',').')  and code ="'.$current_lang.'" ORDER BY text2 ASC';    
                    ...
                    //}
                             ...
                             $sql_option_name3 = 'SELECT * FROM hovvver_categories where code ="'.$current_lang.'" ORDER BY text2 ASC';    
