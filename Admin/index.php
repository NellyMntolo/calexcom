...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/themes/greentheme/views/site/Admin/plugins/morris/morris.css">
              ...
              <ul class="treeview-menu">
                ...
                <a href=""><i class="fa fa-edit"></i>My Shop
                    <span class="pull-right-container">
                      ...
                      <!-- <li><a href="/Admin/Class_Records/"><i class="fa fa-circle-o"></i>Class_Records</a></li>
                      <li><a href="/Admin/Payment_Records/"><i class="fa fa-circle-o"></i>Payment_Records</a></li> -->
                      <!-- <li><a href="/Admin/ServiceRules" style="color:white;"><i class="fa fa-circle-o text-lime"></i>Service Rules</a></li> -->
                      <!-- <li><a href="/Admin/Personal_Settings/"><i class="fa fa-circle-o"></i>Personal_Settings</a></li> -->
                      <!-- <li>
...
<?php /*
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="col-md-4">
              <div class="box box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Recently Added Technologies</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
        ...
        <div class="col-md-4" >
              <div class="box box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Recently Added Case Studies</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
    ...
    <!-- AdminLTE App -->
    <script src="/themes/greentheme/views/site/Admin/Assets/js/app1.js"></script>
    ...
    <script src="/themes/greentheme/views/site/Admin/plugins/morris/morris.min.js"></script>
    <script src="/themes/greentheme/views/site/Admin/plugins/chartjs/Chart.min.js"></script>
