...
$current_lang = $_SESSION['lang'];
                        ...
                        $sqltag = 'select * from hovvver_package_categories WHERE code="'.$current_lang.'" ORDER BY sortable_order ASC';
                        ...
                        $sqltag_order = 'select * from hovvver_package_categories WHERE code="'.$current_lang.'" ORDER BY sortable_order ASC';
