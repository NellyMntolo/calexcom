...
mysql_set_charset("utf8");
                        ...
                        //recent Solutions
                        $sqlrecentsolutions_en1 = 'select * from hovvver_solution where code ="'.$current_lang.'" ORDER BY idx DESC Limit 1';
                        $retval_recentsolutions_en1 = mysql_query( $sqlrecentsolutions_en1, $conn );                 
                             if(! $retval_recentsolutions_en1 )
                             {
                                die('Could not get data: ' . mysql_error());
                             }
                        $sqlrecentsolutions_en = 'select * from hovvver_solution where code ="'.$current_lang.'" ORDER BY idx DESC Limit 2 offset 1';
                        ...
                        //recent Case Studies
                        $sqlrecentprojects_en1 = 'select * from hovvver_project where code ="'.$current_lang.'" ORDER BY sortable_order ASC Limit 1';
                        $retval_recentprojects_en1 = mysql_query( $sqlrecentprojects_en1, $conn );                 
                             if(! $retval_recentprojects_en1 )
                             {
                                die('Could not get data: ' . mysql_error());
                             }
                        $sqlrecentprojects_en = 'select * from hovvver_project where code ="'.$current_lang.'" ORDER BY sortable_order ASC Limit 2 offset 1';
                        ...
                        //recent news
                        $sqlrecentnews_en1 = 'select * from hovvver_blog where code ="'.$current_lang.'" ORDER BY idx DESC Limit 1';
                        $retval_recentnews_en1 = mysql_query( $sqlrecentnews_en1, $conn );                 
                             if(! $retval_recentnews_en1 )
                             {
                                die('Could not get data: ' . mysql_error());
                             }
                        $sqlrecentnews_en = 'select * from hovvver_blog where code ="'.$current_lang.'" ORDER BY idx DESC Limit 2 offset 1';
                        ...
                        //Website Views
                        $sqlviews_en = 'select views from hovvver_index';
                        ...
                        //Published Projects
                        $yes = 'yes';
                        $sqlpublished_en = 'select * from hovvver_project where publish = "'.$yes.'"';
                        ...
                        $sqltotal_en = 'select * from hovvver_project';
                        ...
                        //Published blogs
                        $sqlpublishedblogs_en = 'select * from hovvver_solution where publish = "'.$yes.'"';
                        ...
                        $sqltotalblogs_en = 'select * from hovvver_solution';
