...
$current_lang_now = $_SESSION['lang'];
                        ...
                        //ALL TECHNOLOGY
                        $sql_allthinkers = 'select * from hovvver_solution where code ="'.$current_lang_now.'" ';
                        ...
                        //ALL PRODUCTS
                        $sql_allblogs = 'select * from hovvver_blog where code ="'.$current_lang_now.'" ';
                        ...
                        //ALL PROJECTS
                        $sql_allprojects = 'select * from hovvver_project where code ="'.$current_lang_now.'" ';
                        ...
                        //ALL DEMO
                        $sql_all_demo = 'select * from hovvver_demo where code ="'.$current_lang_now.'" Limit 3';
                        ...
                        //Menu
                        $sql_allmenu = 'select * from hovvver_menu where code ="'.$current_lang_now.'" ';
                        ...
                        $sqlnews_group_active_language = 'select * from lang WHERE status = "'.$news_group_active_languages.'" ';
                            ...
                            $news_group_active_language .= '<li><form method="GET" action="/new_site/Admin/AddTeam/"><button type="submit" class="lang-btn">'.$new_name.'</button><input type="hidden" value="'.$new_code.'" name="lang"><input type="hidden" class="second_misc" name="miscid"></form></li>'; 
                               } 
                        ...
                        $sqlcase_group_active_language = 'select * from lang WHERE status = "'.$case_group_active_languages.'" ';
                            ...
                            $case_group_active_language .= '<li><form method="GET" action="/new_site/Admin/AddClient/"><button type="submit" class="lang-btn">'.$new_name.'</button><input type="hidden" value="'.$new_code.'" name="lang"><input type="hidden" class="second_misc" name="miscid"></form></li>'; 
                               } 
                        ...
                        $sqlsolution_group_active_language = 'select * from lang WHERE status = "'.$solution_group_active_languages.'" ';
                            ...
                            $solution_group_active_language .= '<li><form method="GET" action="/new_site/Admin/AddService/"><button type="submit" class="lang-btn">'.$new_name.'</button><input type="hidden" value="'.$new_code.'" name="lang"><input type="hidden" class="second_misc" name="miscid"></form></li>'; 
                               } 
                        ...
                        $sqlproduct_group_active_language = 'select * from lang WHERE status = "'.$product_group_active_languages.'" ';
                            ...
                            $product_group_active_language .= '<li><form method="GET" action="/new_site/Admin/AddFAQ/"><button type="submit" class="lang-btn">'.$new_name.'</button><input type="hidden" value="'.$new_code.'" name="lang"><input type="hidden" class="second_misc" name="miscid"></form></li>'; 
                               } 
