...
$existing_code [] = '';
                        ...
                        $sqlexisting_language = 'select code from hovvver_index';
                        ...
                        //echo $val;
                            ...
                            while($rowavail_info_language = mysql_fetch_array($retvalavail_info_language, MYSQL_ASSOC)){
                                ...
                                $avail_info_language .= '<tr>
                                                            <td><form method="get" action="/Admin/AllProfile" style="width:30%; float:left;"><button type="submit" class="btn btn-danger btn-flat" title="Remove Language" data-toggle="tooltip"><i class="fa fa-unlink"></i></button><input type="hidden" name="remove_lang" value="'.$avail_idx.'"></form><form method="get" action="/Admin/AllProfile" style="width:30%; float:left;"><button type="submit" class="btn btn-warning btn-flat" title="Deactivate language" data-toggle="tooltip"><i class="fa fa-unlink"></i></button><input type="hidden" name="deactivate_lang" value="'.$avail_idx.'"></form><form method="get" action="/Admin/AllProfile" style="width:30%; float:left;"><button type="submit" class="btn btn-success btn-flat" title="Activate language" data-toggle="tooltip"><i class="fa fa-unlink"></i></button><input type="hidden" name="activate_lang" value="'.$avail_idx.'"></form></td>
                                                            <td>'.$avail_code.'</td>
                                                            <td>'.$avail_name.'</td>
