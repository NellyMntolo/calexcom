...
$current_lang = $_SESSION['lang'];
                        ...
                        $sqlcategory = 'select * from hovvver_categories WHERE code="'.$current_lang.'" ORDER BY sortable_order DESC';
                        ...
                        $sqlcategory_order = 'select * from hovvver_categories WHERE code="'.$current_lang.'" ORDER BY sortable_order ASC';
