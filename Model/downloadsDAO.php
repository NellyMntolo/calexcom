...
$downloadpass = mysql_real_escape_string($_POST['download_pass'],$conn);
                        ...
                        $sqlmain_confirmdownload = 'select * from hovvver_downloads_en where passcode ="'.$downloadpass.'"';
                        ...
                        $sqlmain_downloadsen = 'select * from hovvver_downloads_en where code ="'.$current_lang.'"';
