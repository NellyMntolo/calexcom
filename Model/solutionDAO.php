...
$solutionid = mysql_real_escape_string($_GET['solution_id'],$conn);
//$solutionid = $_SESSION["solution_session"];

//$getName = explode("/",$_SERVER['REQUEST_URI']);


                        $sqlsolutionen = 'select * from hovvver_solution WHERE url="'.$solutionid.'" AND code ="'.$current_lang.'" LIMIT 1';
                        ...
                        $solution_idx = $row_singlesolutionen['idx']; 
                        ...
                        */
                        ...
                        $sqlurlen = 'select * from hovvver_solution WHERE url="'.$solutionid.'" AND code ="'.$current_lang.'" LIMIT 1';
...
//NEXT PREV ENG
                        $firstrow = 'SELECT * FROM hovvver_solution WHERE code ="'.$current_lang.'" ORDER BY sortable_order ASC LIMIT 1';
                        ...
                        $lastrow = 'SELECT * FROM hovvver_solution WHERE code ="'.$current_lang.'" ORDER BY sortable_order DESC LIMIT 1';
                        ...
                        if ($linkurlen == $firstid){
                             $sql = 'SELECT * FROM hovvver_solution where sortable_order = "'.$lastid.'" AND code ="'.$current_lang.'" LIMIT 1'; //OFFSET
                              ...
                              $sql = 'SELECT * FROM hovvver_solution where sortable_order = "'.$linkurlen.'"-1 AND code ="'.$current_lang.'" LIMIT 1'; //OFFSET
                                    $retval = mysql_query( $sql, $conn );                                      
                                    if(! $retval )
                                    {
                                       die('Could not get data: ' . mysql_error());
                          ...
                          if ($linkurlen == $lastid){
                             $sql = 'SELECT * FROM hovvver_solution where sortable_order = "'.$firstid.'" AND code ="'.$current_lang.'" LIMIT 1'; //OFFSET
                                $retval = mysql_query( $sql, $conn );                                  
                                if(! $retval )
                                {
                                   die('Could not get data: ' . mysql_error());
...
*/
                        ...
                        $sqlcase_solution_relateden = 'select * from hovvver_solution WHERE url="'.$solutionid.'" AND code ="'.$current_lang.'" LIMIT 1';
                        ...
                        $sql_related_case_solution_name = 'select * from hovvver_project  WHERE text4 = "'.$case_solution_encategory1.'" OR text4 = "'.$case_solution_encategory2.'" OR text4 = "'.$case_solution_encategory3.'" OR text4 = "'.$case_solution_encategory4.'" OR text4 = "'.$case_solution_encategory5.'" OR text4 = "'.$case_solution_encategory6.'" OR text4 = "'.$case_solution_encategory7.'" OR text4 = "'.$case_solution_encategory8.'" OR text4 = "'.$case_solution_encategory9.'" OR text4 = "'.$case_solution_encategory10.'" ORDER BY idx DESC';  
