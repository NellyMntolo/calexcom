...
function theUrl($link) {
        ...
        if($link==$uri) {
            return 'class="active white"';
        }
    }


                        
                        $sqlmenuen = 'select * from hovvver_menu where code ="'.$current_lang.'"';
                        ...
                        $sqlfooteren_one = 'select * from hovvver_footer where code ="'.$current_lang.'"';
                        $retvalfooteren_one = mysql_query( $sqlfooteren_one, $conn );                 
                             if(! $retvalfooteren_one )
                             {
                                die('Could not get data: ' . mysql_error());
                             }

                        $rowfooteren_one = mysql_fetch_array($retvalfooteren_one, MYSQL_ASSOC);
                            $footer_onetext1 = $rowfooteren_one['text1'];
                            $footer_onetext2 = $rowfooteren_one['text2'];
                            $footer_onetext3 = $rowfooteren_one['text3'];
                            $footer_onetext4 = $rowfooteren_one['text4'];
                            $footer_onetext5 = $rowfooteren_one['text5'];
                            $footer_onetext6 = $rowfooteren_one['text6'];
                            $footer_onetext7 = $rowfooteren_one['text7'];
                            $footer_onetext8 = $rowfooteren_one['text8'];
                            $footer_onetext9 = $rowfooteren_one['text9'];
                            $footer_onetext10 = $rowfooteren_one['text10'];
                            $footer_onetext11 = $rowfooteren_one['text11'];
...
if(isset($_SESSION['login_visitor']) && $_SESSION['customer_type']=="SWD"){
    $menu_account = '<li><div class="account-img"><img src="/themes/greentheme/views/site/Assets/icons/LivenIcons-03.svg"/></div><a href="/Invite">'.$menu_text18.'</a></li>
    <li><div class="account-img"><img src="/themes/greentheme/views/site/Assets/icons/LivenIcons-02.svg"/></div><a href="/Accounts/Sales">'.$menu_text22.'</a></li>
                    <li><div class="account-img"><img src="/themes/greentheme/views/site/Assets/icons/LivenIcons-03.svg"/></div><a href="/LogoutAccount">'.$menu_text23.'</a></li>'; 

} elseif(isset($_SESSION['login_visitor']) && $_SESSION['customer_type']!="SWD"){
    $menu_account = '<li><div class="account-img"><img src="/themes/greentheme/views/site/Assets/icons/LivenIcons-03.svg"/></div><a href="/Invite">'.$menu_text18.'</a></li>
    <li><div class="account-img"><img src="/themes/greentheme/views/site/Assets/icons/LivenIcons-02.svg"/></div><a href="/Accounts/Member">'.$menu_text22.'</a></li>
                    <li><div class="account-img"><img src="/themes/greentheme/views/site/Assets/icons/LivenIcons-03.svg"/></div><a href="/LogoutAccount">'.$menu_text23.'</a></li>'; 
} else {
    $menu_account = '<li><div class="account-img"><img src="/themes/greentheme/views/site/Assets/icons/LivenIcons-03.svg"/></div><a href="/Login">'.$menu_text19.'</a></li>
                    <li><div class="account-img"><img src="/themes/greentheme/views/site/Assets/icons/LivenIcons-03.svg"/></div><a href="/SignUp">'.$menu_text20.'</a></li>'; 
}
...
//echo $currency_to;
                        ...
                        $sqlcasecategory = 'select * from hovvver_categories WHERE code="'.$current_lang.'" ORDER BY sortable_order ASC';
                        ...
                        $casecategories .= '<a href="/CaseStudy/Categories/'.$caseidx.'" class="lvn-grid1-6">
                                                <div class="lvn-cat">
                        ...
                        $sqlmenu_latest_news = 'select * from  hovvver_blog where code ="'.$current_lang.'" order by idx desc limit 3';
                    ...
                    //}
                        ...
                        //MENU Solutions
                        $sqlen_menu_solutions = 'select * from hovvver_solution where code ="'.$current_lang.'" ORDER BY sortable_order ASC';
