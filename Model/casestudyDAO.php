...
$retval_singlecasezh = '';
                        ...
                        $sqlprojecten = 'select * from hovvver_project WHERE url="'.$projectid.'" and code ="'.$current_lang.'" LIMIT 1';
                        ...
                        $sqlprojecten_link = 'select * from hovvver_project WHERE url="'.$projectid.'" and code ="'.$current_lang.'" LIMIT 1';
                        ...
                        $sqloldcasesen = 'select * from hovvver_project WHERE url !="'.$projectid.'" and code ="'.$current_lang.'" ORDER BY idx ASC';
                        ...
                        $sqlcase_relateden = 'select * from hovvver_project WHERE url="'.$projectid.'" and code ="'.$current_lang.'" LIMIT 1';
