...
<!-- Header -->
<header id="header">
  <div class="intro" style="background: url(<?php echo $main_solution_image1;?>) no-repeat center bottom;">
    <div class="container">
      <div class="row">
        <div class="intro-text">
          <h1><?php echo $main_solution_text4; ?></h1>
          <p><?php echo $main_solution_text5; ?></p>
          <!-- <a href="#about" class="btn btn-custom btn-lg page-scroll"><?php echo $main_solution_text6; ?></a> </div> -->
      </div>
    </div>
  </div>
...
<div id="technology" style="padding: 120px 0!important;">
  <div class="container">
    <div class="section-title text-center center">
      <h2><?php echo $main_solution_text6; ?></h2>
      <hr>
    </div>
      <div class="row all-solutions">
        <ul class="grid">
          <?php echo $allsolutions; ?>
        </ul>
      </div>
  </div>
</div>
